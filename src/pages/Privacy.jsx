...
const Privacy = () => {
  ...
  return (
    <div style={containerStyle}>
      ...
      <p style={paragraphStyle}>
        หากคุณมีคำถาม ข้อสงสัย เกี่ยวกับนโยบายความเป็นส่วนตัวของเรา โปรดติดต่อเราได้ที่:
      </p>
      <p style={paragraphStyle}><strong>อีเมล:</strong> [ใส่อีเมลติดต่อสำหรับเรื่องความเป็นส่วนตัว]</p>
      <p style={paragraphStyle}><strong>ที่อยู่:</strong> [ใส่ที่อยู่ของเจ้าของเว็บไซต์ หรือผู้รับผิดชอบเรื่องความเป็นส่วนตัว]</p>
      <p style={noteStyle}>
        หมายเหตุ: โปรดปรับปรุงข้อมูลในวงเล็บ [ ] ให้เป็นข้อมูลที่ถูกต้องของเว็บไซต์ Blackneko-TH.com และตรวจสอบให้แน่ใจว่านโยบายนี้สอดคล้องกับกฎหมายคุ้มครองข้อมูลส่วนบุคคลที่บังคับใช้
      </p>
    </div>
  );
};
