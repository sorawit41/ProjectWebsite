    ...
    <div className="container mx-auto px-4 py-8" style={{ opacity: opacity, transition: 'opacity 1s ease-in-out' }}>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center">
          ...
          <p>ร้านblanknekoมีความตั้งใจที่จะสร้างบรรยากาศในร้านให้น้องแมวและเจ้านายมีความสุขที่สุด ดังนั้นทางเราจึงขอความร่วมมือให้น้องแมวและเจ้านายทุกท่านสร้างบรรยากาศดีๆร่วมกัน หากเกิดความเสียหายต่อทรัพย์สินภายในร้านจะเรียกเก็บค่าเสียหายจริง</p>
        </div>
