        ...
        <div className="py-10 pt-20 bg-white dark:bg-black">
            <div className="container mx-auto px-4">
                ...
                <h2 className="text-3xl font-bold text-center text-gray-800 dark:text-white mb-8 flex items-center justify-center">
                    <FaCat className="mr-2 text-black dark:text-white" />
                    เหล่าๆน้องแมว
                </h2>
                {/* Cast Slider */}
                <div className="w-full overflow-hidden">
                    ...
                    >
                        {cast.map((user, index) => (
                            <div
                                key={index}
                                className="flex-shrink-0 flex-grow-0 w-full inline-block mr-6"
                                style={{ width: '320px' }}
                            >
                                <div
                                    onClick={() => openUserModal(user)}
                                    className="cursor-pointer bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:scale-105 dark:bg-black dark:text-white shadow-md hover:shadow-lg" // เพิ่ม shadow-md และ hover:shadow-lg
                                >
